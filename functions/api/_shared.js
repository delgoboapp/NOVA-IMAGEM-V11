...
const EMPTY_DB = () => ({
  quotes:[], orders:[], clients:[], users:[], disabledUsers:[], products:[], suppliers:[], payables:[], purchaseOrders:[], reworks:[], agenda:[], purchaseAlerts:[], auditLog:[], attachments:[], customerFeedback:[],
...
function normalize(parsed={}){
  const base=EMPTY_DB();
  for(const k of ['quotes','orders','clients','users','disabledUsers','products','suppliers','payables','purchaseOrders','reworks','agenda','purchaseAlerts','auditLog','attachments','customerFeedback']) base[k]=Array.isArray(parsed[k])?parsed[k]:[];
